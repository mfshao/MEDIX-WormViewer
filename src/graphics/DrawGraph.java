...
public class DrawGraph extends JPanel {
    ...
    public DrawGraph(List<Integer> scores) {
        ...
        System.out.println("DG FINISHED");
    }
...
//        xScale = (int) Math.round(((double) getWidth() - 2 * BORDER_GAP) / (scores.size() - 1));
//        yScale = (int) Math.round(((double) getHeight() - 2 * BORDER_GAP) / (MAX_SCORE - 1));
